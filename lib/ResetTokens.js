...
module.exports =(email,res,userdb,tokendb) => {
    return new Promise((resolve,reject)=>{
        userdb.find({ email : email },(err,result)=>{
          ...
          let token = tokendb.findOne({ userId: result._id });
          ...
          .then(hash =>{
            ...
            // construct link for user based on the link, link contains url encoded data to be submitted with the reset form
