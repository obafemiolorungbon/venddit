module.exports  = (auth,req,res) => {
    return new Promise((resolve, reject)=>{
        //when user successfully logs in or registers successfully, you cookie them
        //with a signed token that expires after some times
        //for that create a fnction that creates token
        //another tht creates the cookie
